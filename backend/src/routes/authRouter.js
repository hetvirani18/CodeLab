...
const {register, login, logout, getProfile, adminRegistor, deleteProfile, updateProfile, getUserActivity, getPublicProfile} = require('../controllers/authController');
...
authRouter.get('/public-profile/:id', getPublicProfile);
